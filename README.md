# 🧩 Satisfier API in Code::Blocks IDE
...
[`The Dynmamics of Decision-Making Styles`]: https://github.com/calebnwokocha/satisfier/blob/main/articles/the_dynamics_of_decision-making_styles.pdf
