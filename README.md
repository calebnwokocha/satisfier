...
- **Files** required in your project folder:
  ...
  If you are downloading Code::Blocks for the first time, then you don't need this tutorial. Just download and extract `codeblocks-satisfier-nosetup` via https://huggingface.co/caletechnology/codeblocks-satisfier-nosetup/tree/main and open `client.cpp`
---
